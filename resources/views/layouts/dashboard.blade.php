...
<head>
    ...
    <title>@yield('title') &mdash; File Manager</title>
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-link-lg nav-link-user"
                            ...
                            <img src="{{ asset('stisla/assets/img/avatar/avatar-1.png') }}" alt="image"
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('home') ? 'active' : '' }}">
                            <a href="" class="nav-link active"><i class="bi bi-people-fill "></i>
